...
use Statistics\Calculator\AveragePostsPerUserPerMonthCalculator;
...
class StatisticsCalculatorFactory
{
    ...
    private const CALCULATOR_CLASS_MAP = [
        ...
        StatsEnum::AVERAGE_POSTS_NUMBER_PER_USER_PER_MONTH => AveragePostsPerUserPerMonthCalculator::class,
    ];
